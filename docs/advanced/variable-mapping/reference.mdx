...
### Microstrate-Specific Extensions
...
<Info>
The pipe operator (`|`) is a Microstrate custom extension not found in standard JSONPath implementations.
</Info>
...
**Solutions:** Remove spaces around pipes, check all referenced values exist, and remember that `|` is a Microstrate custom extension (not standard JSONPath).
  </Accordion>
...
```json Microstrate Equivalent
// Microstrate uses $.NODE_ID.path
"$.step1.customer.name"
...
<Info>
**Key Difference:** Microstrate uses standard JSONPath syntax with custom extensions, making it more powerful for complex data transformations.
</Info>
...
<Tip>
**Bookmark this page!** This reference guide contains everything you need for JSONPath mapping in Microstrate flows.
</Tip>