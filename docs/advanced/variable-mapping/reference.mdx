...
<Info>
The pipe operator (`|`) is a quiva.ai custom extension not found in standard JSONPath implementations.
</Info>
...
**Solutions:** Remove spaces around pipes, check all referenced values exist, and remember that `|` is a quiva.ai custom extension (not standard JSONPath).
  </Accordion>
...
```json quiva.ai Equivalent
// quiva.ai uses $.NODE_ID.path
"$.step1.customer.name"
...
<Info>
**Key Difference:** quiva.ai uses standard JSONPath syntax with custom extensions, making it more powerful for complex data transformations.
</Info>
...
<Tip>
**Bookmark this page!** This reference guide contains everything you need for JSONPath mapping in quiva.ai flows.
</Tip>