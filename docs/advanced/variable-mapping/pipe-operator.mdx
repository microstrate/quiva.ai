---
title: "Pipe Operator"
description: "Build dynamic strings with quiva.ai's custom concatenation operator"
---

The pipe operator (`|`) is a quiva.ai-specific extension that enables powerful string concatenation and handling of missing values. It's one of the most frequently used features for building dynamic content.

<Info>
The pipe operator is **not** part of standard JSONPath. It's a custom quiva.ai feature designed to make string building easier and more intuitive.
</Info>
