---
title: "Basic Syntax"
description: "Learn the fundamentals of accessing and mapping data in quiva.ai flows"
---

## The Two Data Sources

quiva.ai flows work with two primary data sources that you can reference using variable mapping:
...
<Info>
The `$.` prefix tells quiva.ai to evaluate this as a variable mapping expression rather than treating it as a literal string.
</Info>
