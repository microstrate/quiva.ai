---
title: "Basic Syntax"
description: "Learn the fundamentals of accessing and mapping data in Microstrate flows"
---

## The Two Data Sources

Microstrate flows work with two primary data sources that you can reference using variable mapping:
...
<Info>
The `$.` prefix tells Microstrate to evaluate this as a variable mapping expression rather than treating it as a literal string.
</Info>
