...
When building flows in Quiva, you work with two primary data sources:
...
<Info>
Variable mapping is powered by [JSONPath Plus v1.1.0](https://github.com/JSONPath-Plus/JSONPath) with custom Quiva extensions for enhanced functionality.
</Info>
...
<Steps>
  ...
  <Step title="Try the Pipe Operator">
    Build dynamic strings using Quiva's custom `|` concatenation
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Pipe Operator" icon="3" href="/advanced/variable-mapping/pipe-operator">
    Quiva's string concatenation and fallbacks
  </Card>
