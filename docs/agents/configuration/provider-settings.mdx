...
<Tabs>
  <Tab title="Workforce (Recommended)">
    <div className="space-y-4">
      <p><strong>Quiva's custom model</strong> optimized for business automation and agent workflows.</p>
      ...
      **Advantages:**
      ...
      - ✅ Optimized for Quiva's agent architecture
...
<Info>
**Why do I need an API key?** API keys authenticate your requests to the AI provider and allow them to track usage and bill accordingly. Keys are encrypted and securely stored in Quiva.
</Info>
...
<Steps>
  ...
  <Step title="Create Your API Key">
    ...
    3. In the popup dialog:
       - **Name**: Give your key a descriptive name (e.g., "Quiva Production" or "Quiva Development")
  ...
  <Step title="Add Key to Quiva">
    1. In Quiva, open your agent configuration
...
<Steps>
  ...
  <Step title="Create Your API Key">
    ...
    3. In the dialog that appears:
       - **Name**: Enter a descriptive name for your key
         - Examples: "Quiva Production", "Customer Service Agent", "Development Testing"
  ...
  <Step title="Add Key to Quiva">
    ...
    7. Quiva encrypts and securely stores your key
...
<Steps>
  ...
  <Step title="Create a Google Cloud Project">
    ...
    4. Create your project:
       - Enter a **Project name** (e.g., "Quiva Agents", "AI Development")
...
### Adding Your API Key to Quiva

Once you have an API key from any provider, follow these steps to add it to Quiva:
