...
<Tabs>
  <Tab title="Workforce (Recommended)">
    <div className="space-y-4">
      <p><strong>Microstrate's custom model</strong> optimized for business automation and agent workflows.</p>
      
      **Best for:**
      - Getting started quickly (no API key needed)
      - Cost-effective automation
      - Standard business use cases
      - Testing and prototyping
      
      **Advantages:**
      - ✅ Included in all plans (no additional API costs)
      - ✅ Optimized for Microstrate's agent architecture
      - ✅ Balanced performance and cost
      - ✅ No external API key management
      - ✅ Predictable pricing
      
      **Limitations:**
      - ⚠️ Less customization than bringing your own models
      - ⚠️ May not have cutting-edge features of latest GPT-4 or Claude releases
    </div>
  </Tab>
  ...
  <Tab title="OpenAI">
    <div className="space-y-4">
      ...
      **Advantages:**
      - ✅ GPT-4 is most capable model available
      - ✅ Extensive training on diverse data
      - ✅ Strong general intelligence
      - ✅ Excellent for creative tasks
      - ✅ Fast inference (especially GPT-3.5)
      
      **Considerations:**
      - ⚠️ Requires OpenAI API key
      - ⚠️ GPT-4 is more expensive than alternatives
  ...
  <Tab title="Claude (Anthropic)">
    <div className="space-y-4">
      ...
      **Considerations:**
      ...
      - ⚠️ Costs based on token usage
      - ⚠️ May be slower than GPT-3.5 for simple tasks
  ...
  <Tab title="Gemini (Google)">
    <div className="space-y-4">
      ...
      **Considerations:**
      ...
      - ⚠️ Newer models (less battle-tested)
      - ⚠️ Costs based on token usage
      - ⚠️ May not match GPT-4 on complex reasoning
...
| Feature | Workforce | OpenAI | Claude | Gemini |
|---------|-----------|---------|---------|---------|
| **Setup** | Instant | API Key | API Key | API Key |
| **Cost** | Included | Usage-based | Usage-based | Usage-based |
| **Best at** | Business automation | General intelligence | Long context | Multimodal |
| **Speed** | Fast | Fast | Moderate | Fast |
| **Context** | 50K-100K | 128K | 200K | 32K-128K |
| **Learning Curve** | Low | Low | Low | Moderate |

<Tip>
**Start with Workforce** for simplicity. Upgrade to external providers when you need specific capabilities or have exhausted included usage.
</Tip>
...
<Info>
**Why do I need an API key?** API keys authenticate your requests to the AI provider and allow them to track usage and bill accordingly. Keys are encrypted and securely stored in Microstrate.
</Info>
...
<Steps>
  ...
  <Step title="Create Your API Key">
    ...
    3. In the popup dialog:
       - **Name**: Give your key a descriptive name (e.g., "Microstrate Production" or "Microstrate Development")
  ...
  <Step title="Add Key to Microstrate">
    1. In Microstrate, open your agent configuration
...
<Steps>
  ...
  <Step title="Create Your API Key">
    ...
    3. In the dialog that appears:
       - **Name**: Enter a descriptive name for your key
         - Examples: "Microstrate Production", "Customer Service Agent", "Development Testing"
  ...
  <Step title="Add Key to Microstrate">
    ...
    7. Microstrate encrypts and securely stores your key
...
<Steps>
  ...
  <Step title="Create a Google Cloud Project">
    ...
    4. Create your project:
       - Enter a **Project name** (e.g., "Microstrate Agents", "AI Development")
...
### Adding Your API Key to Microstrate

Once you have an API key from any provider, follow these steps to add it to Microstrate:
