...
<Tabs>
  <Tab title="Workforce (Recommended)">
    <div className="space-y-4">
      <p><strong>quiva.ai's custom model</strong> optimized for business automation and agent workflows.</p>
      ...
      **Advantages:**
      ...
      - ✅ Optimized for quiva.ai's agent architecture
...
<Info>
**Why do I need an API key?** API keys authenticate your requests to the AI provider and allow them to track usage and bill accordingly. Keys are encrypted and securely stored in quiva.ai.
</Info>
...
<Steps>
  ...
  <Step title="Create Your API Key">
    ...
    3. In the popup dialog:
       - **Name**: Give your key a descriptive name (e.g., "quiva.ai Production" or "quiva.ai Development")
  ...
  <Step title="Add Key to quiva.ai">
...
<Steps>
  ...
  <Step title="Create Your API Key">
    ...
    3. In the dialog that appears:
       - **Name**: Enter a descriptive name for your key
         - Examples: "quiva.ai Production", "Customer Service Agent", "Development Testing"
  ...
  <Step title="Add Key to quiva.ai">
    ...
    7. quiva.ai encrypts and securely stores your key
...
<Steps>
  ...
  <Step title="Create a Google Cloud Project">
    ...
    4. Create your project:
       - Enter a **Project name** (e.g., "quiva.ai Agents", "AI Development")
...
### Adding Your API Key to quiva.ai

Once you have an API key from any provider, follow these steps to add it to quiva.ai:
