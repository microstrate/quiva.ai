...
Agents are the intelligence layer of Microstrate. They're AI-powered workers that can understand context, reason through problems, use tools, and make decisions—all within boundaries you define.
...
<CardGroup cols={3}>
  ...
  <Card title="Microstrate Agents" icon="robot">
    **"Digital workforce"**
