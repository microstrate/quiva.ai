...
[does not exist](/forms/form-rules#when-a-rule-silently-hides-a-field).
</Note>
...
this engine does not. A rule using one evaluates to nothing, and a **Visible** rule that evaluates to
nothing hides the field permanently and silently. Check the generated condition against
[the operator list](/forms/form-rules#the-operators-that-work), and preview the form before saving.
</Warning>
