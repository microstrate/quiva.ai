...
Embed triggers allow you to add interactive elements to your website or web application that trigger Microstrate flows. With simple copy-paste embed code, you can add buttons, forms, or chat interfaces that connect directly to your intelligent agents.
...
<Steps>
  ...
  <Step title="Get Embed Code">
    ...
    **Example embed code:**
    ```html
    <button id="microstrate-button" 
            data-flow-id="abc123"
            data-action="chat">
      Chat with Support
    </button>
    <script src="https://cdn.microstrate.ai/embed.js"></script>
    <script>
      MicrostrateEmbed.init({
        flowId: 'abc123',
...
<Steps>
  ...
  <Step title="Style Your Form">
    ...
    **Via Custom CSS:**
    ...
    .microstrate-form input,
    .microstrate-form textarea {
      width: 100%;
      padding: 12px;
    ...
    .microstrate-form button[type="submit"] {
      background: #4641F2;
      color: white;
      padding: 14px 32px;
      border-radius: 8px;
  ...
  <Step title="Get Embed Code">
    ...
    **Example embed code:**
    ```html
    <div id="microstrate-form-container"></div>
    <script src="https://cdn.microstrate.ai/embed.js"></script>
    <script>
      MicrostrateEmbed.renderForm({
        containerId: 'microstrate-form-container',
        flowId: 'abc123',
...
<Steps>
  ...
  <Step title="Get Embed Code">
    ...
    **Option 3: Button-Triggered Modal**
    ...
    <script src="https://cdn.microstrate.ai/embed.js"></script>
    <script>
      const chat = MicrostrateEmbed.createChat({
        flowId: 'abc123',
        displayMode: 'modal'
      });
  ...
  <Accordion title="Styling issues" icon="palette">
    ...
    **Solutions:**
    ...
    - Increase CSS specificity if needed:
      ```css
      .microstrate-chat-widget.microstrate-chat-widget {
        /* Higher specificity */
      }
      ```
  </Accordion>
