...
Retrieve secret values stored in quiva.ai's secret manager. Use this to securely access API keys, tokens, and other sensitive configuration.
...
Invoke other quiva.ai functions programmatically from within your flow. Useful for orchestrating complex workflows and modular function composition.
...
<Info>
**Implementation**: Uses quiva.ai SDK func.invoke() method. Ensures proper function calling within the platform's execution environment.
</Info>
