...
Flows are the foundation of automation in quiva.ai. They allow you to build intelligent workflows that combine AI agents, business logic, data transformation, and integrations to automate complex business processes.
...
quiva.ai flows are designed around **AI agents** as the primary intelligence layer. While traditional automation requires you to program every step, agent-centric flows allow you to:
...
The optimal flow pattern in quiva.ai:
