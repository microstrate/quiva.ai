...
<Info>
**Agent-Centric Design**: Quiva flows are designed to be agent-first. Start with an AI agent, attach tools (connectors) to it, and add supporting steps as needed. This approach maximizes the intelligence and autonomy of your workflows.
</Info>
...
Traditional workflow tools force you to map out every step explicitly. Quiva is different—**you delegate work to intelligent agents** and let them figure out the details.
