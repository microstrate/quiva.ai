...
<Note>
**Assistants are not Abbie.** Assistants are bots you build and configure for a particular job.
[Abbie](/abbie/getting-started/introduction) is the single AI coworker already built into
QuivaWorks, with her own memory, backlog and settings.
</Note>
