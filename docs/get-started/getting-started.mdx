...
# Getting Started with quiva.ai

Welcome to quiva.ai! This guide will help you create your account and get started building intelligent AI agents in minutes.
...
<CardGroup cols={2}>
  ...
  <Card title="API Documentation" icon="code" href="/api-reference">
    Integrate quiva.ai programmatically
  </Card>
</CardGroup>
