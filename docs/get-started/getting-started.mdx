...
# Getting Started with Quiva

Welcome to Quiva! This guide will help you create your account and get started building intelligent AI agents in minutes.
...
<CardGroup cols={2}>
  ...
  <Card title="API Documentation" icon="code" href="/api-reference">
    Integrate Quiva programmatically
  </Card>
</CardGroup>
