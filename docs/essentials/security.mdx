...
Microstrate provides robust MFA options to protect your account. If MFA is not active, everytime you log into your account you will be prompted to set up MFA:
...
1. **Initiating Password Recovery**
   - Visit the Microstrate login page at [https://app.staging.microstrate.ai/en/login](https://app.staging.microstrate.ai/en/login)
...
6. **Report the Incident**
   - Contact Microstrate security team at [security@microstrate.ai](mailto:security@microstrate.ai)
...
Report security incidents to [security@microstrate.ai](mailto:security@microstrate.ai) or call the emergency response line at the number provided in your account portal.
...
- [Microstrate Security Whitepaper](https://docs.microstrate.ai/security/whitepaper)
- [Security Best Practices Guide](https://docs.microstrate.ai/security/best-practices)
- [Compliance Documentation](https://docs.microstrate.ai/security/compliance)
- [Security Changelog](https://docs.microstrate.ai/security/updates)