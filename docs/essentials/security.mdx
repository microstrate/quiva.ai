...
Security is foundational to quiva.ai's architecture. This guide outlines the security features available to protect your account and data, along with best practices for maintaining a strong security posture.

## Account Security Features

### Multi-Factor Authentication (MFA)

quiva.ai provides robust MFA options to protect your account. If MFA is not active, everytime you log into your account you will be prompted to set up MFA:
...
Secure your programmatic access to quiva.ai:
...
quiva.ai implements Secop (Secure Operation) security models throughout the platform:
...
If you've forgotten your password, quiva.ai provides a secure recovery process:

1. **Initiating Password Recovery**
   - Visit the quiva.ai login page at [https://app.staging.quiva.ai/en/login](https://app.staging.quiva.ai/en/login)
   - Click "Forgot password?" below the login form
   - Enter the email address associated with your account
   - Click "Send Recovery Email"

2. **Completing the Recovery Process**
   - Check your email for a message from quiva.ai (subject: "Reset Your quiva.ai Password")
...
- Access the quiva.ai console over HTTPS only
...
quiva.ai provides comprehensive security monitoring tools:
...
6. **Report the Incident**
   - Contact quiva.ai security team at [security@quiva.ai](mailto:security@quiva.ai)
...
Report security incidents to [security@quiva.ai](mailto:security@quiva.ai) or call the emergency response line at the number provided in your account portal.

## Security Compliance

quiva.ai maintains the following certifications and compliance standards:
...
- [quiva.ai Security Whitepaper](https://docs.quiva.ai/security/whitepaper)
