...
Security is foundational to Quiva's architecture. This guide outlines the security features available to protect your account and data, along with best practices for maintaining a strong security posture.

## Account Security Features

### Multi-Factor Authentication (MFA)

Quiva provides robust MFA options to protect your account. If MFA is not active, everytime you log into your account you will be prompted to set up MFA:
...
Secure your programmatic access to Quiva:
...
Quiva implements Secop (Secure Operation) security models throughout the platform:
...
If you've forgotten your password, Quiva provides a secure recovery process:

1. **Initiating Password Recovery**
   - Visit the Quiva login page at [https://app.staging.quiva.ai/en/login](https://app.staging.quiva.ai/en/login)
   - Click "Forgot password?" below the login form
   - Enter the email address associated with your account
   - Click "Send Recovery Email"

2. **Completing the Recovery Process**
   - Check your email for a message from Quiva (subject: "Reset Your Quiva Password")
...
- Access the Quiva console over HTTPS only
...
Quiva provides comprehensive security monitoring tools:
...
6. **Report the Incident**
   - Contact Quiva security team at [security@quiva.ai](mailto:security@quiva.ai)
...
Quiva maintains the following certifications and compliance standards:
...
- [Quiva Security Whitepaper](https://docs.quiva.ai/security/whitepaper)
