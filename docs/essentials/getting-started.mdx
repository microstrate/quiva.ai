...
# Getting Started with Microstrate

Welcome to Microstrate! This guide will help you create your account and get started building intelligent AI agents in minutes.
...
2. Complete the registration form with:
   ...
   - **Country**
   - **First and Last Name**
3. Accept our [Terms](https://microstrate.io/legal.html#terms) and [Privacy Policy](https://microstrate.io/legal.html#privacy)
4. Complete Cloudflare verification
...
<CardGroup cols={2}>
  <Card title="Free" icon="gift" href="/essentials/plans-and-pricing#free">
  ...
  <Card title="Starter" icon="seedling" href="/essentials/plans-and-pricing#starter">
  ...
  <Card title="Pro" icon="chart-line" href="/essentials/plans-and-pricing#pro">
  ...
  <Card title="Team" icon="users" href="/essentials/plans-and-pricing#team">
...
<Info>
You can change your plan at any time. See our complete [Pricing & Plans guide](/essentials/plans-and-pricing) for detailed comparisons.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="API Documentation" icon="code" href="/api-reference">
    Integrate Microstrate programmatically
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  ...
  <Card title="Community" icon="users" href="https://community.microstrate.io">
