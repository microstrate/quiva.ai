...
description: "Understanding quiva.ai's security features and how to protect your account"
icon: "shield"
---

# Security Overview

Security is foundational to quiva.ai's architecture. This guide provides an overview of platform security and helps you navigate our security documentation.

## Quick Security Setup

New to quiva.ai? Complete these essential security steps:
...
Contact [privacy@quiva.ai](mailto:privacy@quiva.ai) to exercise your rights.
...
2. Email [security@quiva.ai](mailto:security@quiva.ai) with:
