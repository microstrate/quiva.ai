...
description: "Understanding Quiva's security features and how to protect your account"
icon: "shield"
---

# Security Overview

Security is foundational to Quiva's architecture. This guide provides an overview of platform security and helps you navigate our security documentation.

## Quick Security Setup

New to Quiva? Complete these essential security steps:
