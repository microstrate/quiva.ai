...
API keys allow you to access quiva.ai programmatically for automation, integrations, and custom applications.
...
<Info>
While quiva.ai doesn't currently provide audit logs for API usage, we recommend implementing logging in your applications that use API keys to track their usage patterns.
</Info>
