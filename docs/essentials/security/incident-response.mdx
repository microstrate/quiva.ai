...
<AccordionGroup>
  ...
  <Accordion title="Use HTTPS Only" icon="lock">
    ...
    ```javascript
    // Always use HTTPS
    const url = "https://api.microstrate.io/v1/agents";
    ```
  </Accordion>
...
3. **Email** [security@microstrate.io](mailto:security@microstrate.io) with:
...
To exercise your rights, contact [privacy@microstrate.io](mailto:privacy@microstrate.io).

## Compliance Resources

<CardGroup cols={2}>
  <Card title="Privacy Policy" icon="file-contract" href="https://microstrate.io/legal.html#privacy">
    Complete privacy policy and data handling practices
  </Card>
  
  <Card title="Terms of Service" icon="handshake" href="https://microstrate.io/legal.html#terms">
...
<CardGroup cols={3}>
  <Card title="Security Issues" icon="shield-halved" href="mailto:security@microstrate.io">
    security@microstrate.io
    
    Report vulnerabilities and incidents
  </Card>
  
  <Card title="Privacy Questions" icon="user-lock" href="mailto:privacy@microstrate.io">
    privacy@microstrate.io
