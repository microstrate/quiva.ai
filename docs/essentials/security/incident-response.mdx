...
description: "Comprehensive guide to securing your Microstrate account and understanding platform security"
icon: "shield"
---

# Security Overview

Security is foundational to Microstrate's architecture. This comprehensive guide outlines the security features available to protect your account and data, along with best practices for maintaining a strong security posture.

## Platform Security

Microstrate is built with enterprise-grade security from the ground up.
...
<AccordionGroup>
  <Accordion title="Encryption at Rest" icon="lock">
    **AES-256 Encryption**
    ...
    All data stored within Microstrate is encrypted at rest using industry-standard AES-256 encryption:
  ...
  <Accordion title="Encryption in Transit" icon="shield-halved">
    **TLS 1.3**
    ...
    All data transmitted to and from Microstrate is protected using TLS 1.3:
...
Microstrate's proprietary multi-cloud mesh architecture provides resilience and security:
...
Microstrate supports two MFA methods:
...
<AccordionGroup>
  <Accordion title="Use Strong, Unique Passwords" icon="key">
    **Password Requirements:**
    ...
    - Unique to Microstrate (never reuse)
  ...
  <Accordion title="Keep Software Updated" icon="arrow-up">
    ...
    - **Mobile Apps**: Keep Microstrate app updated
...
<AccordionGroup>
  <Accordion title="Secure API Keys" icon="code">
    ...
    **Do:**
    ...
    export MICROSTRATE_API_KEY="your-key"
    ```
  ...
  <Accordion title="Use HTTPS Only" icon="lock">
    ...
    ```javascript
    // Always use HTTPS
    const url = "https://api.microstrate.ai/v1/agents";
    ```
  </Accordion>
...
Microstrate sends automatic email notifications for important security events:
...
3. **Email** [security@microstrate.ai](mailto:security@microstrate.ai) with:
...
<CardGroup cols={2}>
  ...
  <Card title="Terms of Service" icon="handshake" href="https://microstrate.ai/legal.html#terms">
