...
description: "Comprehensive guide to securing your Quiva account and understanding platform security"
icon: "shield"
---

# Security Overview

Security is foundational to Quiva's architecture. This comprehensive guide outlines the security features available to protect your account and data, along with best practices for maintaining a strong security posture.

## Platform Security

Quiva is built with enterprise-grade security from the ground up.
...
<AccordionGroup>
  <Accordion title="Encryption at Rest" icon="lock">
    **AES-256 Encryption**
    ...
    All data stored within Quiva is encrypted at rest using industry-standard AES-256 encryption:
  ...
  <Accordion title="Encryption in Transit" icon="shield-halved">
    **TLS 1.3**
    ...
    All data transmitted to and from Quiva is protected using TLS 1.3:
...
Quiva's proprietary multi-cloud mesh architecture provides resilience and security:
...
Quiva supports two MFA methods:
...
<AccordionGroup>
  ...
  <Accordion title="Keep Software Updated" icon="arrow-up">
    ...
    - **Mobile Apps**: Keep Quiva app updated
...
Quiva sends automatic email notifications for important security events:
