...
# Understanding quiva.ai Compute Credits

## The Smarter Way to Pay for Cloud Resources

quiva.ai's compute credit system represents a fundamental shift in how cloud resources are allocated and billed. Rather than paying for idle resources based on memory blocks, our innovative approach uses precision CPU allocation to ensure you only pay for what you actually use. This guide explains how our credit system works and how to estimate your needs.
...
quiva.ai offers different compute modes to optimize for various workload requirements:
...
| ------------------------ | ------------ | ----------------------------------------- |
| Base quiva.ai Rate    | 0.0000000210 | Per millisecond of compute time           |
...
## Why This Matters: The quiva.ai Advantage
...
## Understanding Millicores: The Key to quiva.ai's Efficiency

### What Are Millicores?

A millicore is a unit of CPU allocation that represents 1/1000th of a CPU core. This fine-grained approach to resource allocation is central to quiva.ai's efficiency advantage:

- Traditional cloud platforms allocate entire CPU cores or rigid fractions (like 0.25 or 0.5 cores)
- quiva.ai allocates precise millicore amounts based on your workload needs
- 1000 millicores = 1 full CPU core

### How Millicores Work in quiva.ai

Unlike traditional serverless and container platforms that bundle CPU and memory into fixed configurations, quiva.ai's Hydra compute engine decouples these resources:
...
In quiva.ai, memory tiers and millicores have a defined relationship expressed through the Memory Price Scaler:
