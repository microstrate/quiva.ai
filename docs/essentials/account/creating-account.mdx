...
description: "Step-by-step guide to creating and setting up your Quiva account"
icon: "user-plus"
---

# Creating Your Account

Get started with Quiva in just a few minutes. This guide walks you through account creation, email verification, and initial setup.
...
<Note>
**About Account Names:** The account name allows the same email address to be used across multiple Quiva accounts. Choose something memorable as you'll use it every time you log in.
</Note>
...
<Tip>
Start with the Free plan to explore Quiva. You can upgrade at any time as your needs grow.
</Tip>
...
<AccordionGroup>
  ...
  <Accordion title="Account name already taken">
    **Remember:**
    ...
    - They must be unique across all Quiva accounts
...
You can use the same email address for multiple Quiva accounts by choosing different account names.
