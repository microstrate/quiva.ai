...
description: "Step-by-step guide to creating and setting up your quiva.ai account"
icon: "user-plus"
---

# Creating Your Account

Get started with quiva.ai in just a few minutes. This guide walks you through account creation, email verification, and initial setup.
...
<Note>
**About Account Names:** The account name allows the same email address to be used across multiple quiva.ai accounts. Choose something memorable as you'll use it every time you log in.
</Note>
...
<Tip>
Start with the Free plan to explore quiva.ai. You can upgrade at any time as your needs grow.
</Tip>
...
<AccordionGroup>
  ...
  <Accordion title="Account name already taken">
    **Remember:**
    ...
    - They must be unique across all quiva.ai accounts
...
You can use the same email address for multiple quiva.ai accounts by choosing different account names.
