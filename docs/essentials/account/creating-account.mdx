...
description: "Step-by-step guide to creating and setting up your Microstrate account"
icon: "user-plus"
---

# Creating Your Account

Get started with Microstrate in just a few minutes. This guide walks you through account creation, email verification, and initial setup.
...
<Steps>
  <Step title="Visit the Signup Page">
    Navigate to [https://app.microstrate.io/en/signup](https://app.microstrate.io/en/signup)
  </Step>
  ...
  <Step title="Accept Terms">
    Review and accept our [Terms of Service](https://microstrate.io/legal.html#terms) and [Privacy Policy](https://microstrate.io/legal.html#privacy)
  </Step>
...
<Note>
**About Account Names:** The account name allows the same email address to be used across multiple Microstrate accounts. Choose something memorable as you'll use it every time you log in.
</Note>
...
<CardGroup cols={2}>
  <Card title="Free - $0/month" icon="gift">
    ...
    [View details →](/essentials/plans-and-pricing#free)
  </Card>
  ...
  <Card title="Starter - $20/month" icon="seedling">
    ...
    [View details →](/essentials/plans-and-pricing#starter)
  </Card>
  ...
  <Card title="Pro - $100/month" icon="chart-line">
    ...
    [View details →](/essentials/plans-and-pricing#pro)
  </Card>
  ...
  <Card title="Team - $500/month" icon="users">
    ...
    [View details →](/essentials/plans-and-pricing#team)
  </Card>
</CardGroup>
...
<Tip>
Start with the Free plan to explore Microstrate. You can upgrade at any time as your needs grow.
</Tip>
...
<AccordionGroup>
  ...
  <Accordion title="Account name already taken">
    **Remember:**
    ...
    - They must be unique across all Microstrate accounts
...
You can use the same email address for multiple Microstrate accounts by choosing different account names.
