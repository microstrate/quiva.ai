...
- **Calendars** — connects your calendars, so the notetaker can join your meetings. See [Connecting a calendar](/meetings/connecting-a-calendar).
- **Recordings** — your meeting recordings. See [Recordings](/meetings/recordings).
- **Summarization Templates** — the templates used to summarise meetings. See [Summaries and templates](/meetings/summaries).
