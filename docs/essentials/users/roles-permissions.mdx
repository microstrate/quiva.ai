...
Microstrate provides five predefined roles to help you control access levels across your team. This guide details what each role can and cannot do.
...
<AccordionGroup>
  <Accordion title="Can I create custom roles?">
    No, Microstrate provides five predefined roles. These roles cover most use cases. For Enterprise customers with specific needs, contact us about custom permissions.
  </Accordion>
