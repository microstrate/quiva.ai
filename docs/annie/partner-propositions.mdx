...
### Strategy Documents
- [SOTA Landscape](annie/sota-landscape.mdx) -- Fable 5 precedent, sovereign AI imperative, open-weight ecosystem viability
- [Annie Architecture](annie/annie-architecture.mdx) -- Hierarchical MoE design, Bellerophon BStream backbone, hardware requirements, consensus verification pipeline
